...
for all $a_1, \dotsc, a_n, b_1, \dotsc, b_n \in \R$. In other words, ``the square of the sum of the products is at most the product of the sum of the squares.'' Using the dot product, this can be phrased more succinctly as $|v \cdot w|^2 \leq |v|^2 |w|^2$ for all $v, w \in \R^n$. For a proof, see \cite[theorem 6.1]{protter-morrey}, for instance.}
...
Here are two examples we've already seen. 
...
\begin{proof}
	...
	\[ |\ell(v)|_\mx = |a_1w_1 + \dotsb + a_r w_r| = \max\{ |a_1|, \dotsc, |a_r| \} \leq \max\{ |a_1|, \dotsc, |a_n|\} =  |v|_\mx \]
