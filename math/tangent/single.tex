...
\begin{exercise}[Concavity and extremums]
...
\begin{exercise}[Concavity and derivatives] \label{concavity-derivative}
	...
	\end{enumerate}
	\begin{hint}
		If $f'$ is increasing, apply the mean value theorem \ref{mean-value-theorem} to prove that $f$ is concave up. Conversely, if $f$ is concave up, suppose we have $a < b$ in $I$. Let $x$ and $y$ be such that $a < x < y < b$. Explain why 
