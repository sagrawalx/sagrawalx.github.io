...
The intermediate value theorem, mean value theorem, and Darboux's theorem all say similar things, and invite direct comparison. I encourage you to ensure that you understand how the statements differ. See \cref{ivt-mvt-darboux}.
...
\begin{table}[ht]
	...
	\begin{tabular}{ p{0.17\textwidth} p{0.23\textwidth} p{0.23\textwidth} p{0.23\textwidth} } 
		...
		If $f : [a, b] \to \R$ is... & continuous & continuous and differentiable on the interior & differentiable on an open neighborhood of $[a,b]$ \\ \addlinespace[1em]
...
% TODO: do the generalization; in particular, at least prove that the convergence of the functions themselves is uniform.
