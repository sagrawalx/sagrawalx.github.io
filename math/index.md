...
* [Contangent complex]({{ site.baseurl}}/math/cotangent.pdf). Some incomplete notes I compiled when I was preparing for a talk I gave in Nadler's Fall 2013 Geometric Representation Theory Seminar.
* [Fundamental group of a curve]({{ site.baseurl}}/math/fg-curve.pdf). An expository term paper from Olsson's Spring 2012 Algebraic Geometry course.
