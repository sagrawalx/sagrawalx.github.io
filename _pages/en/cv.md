...
<img class="sidepic" src="{{ site.baseurl }}/assets/hello-bunny.svg" title="Hello!"/>

# Employment

* UC San Diego. SEW Visiting Assistant Professor (2022--). 
    - Mentor: [Kiran Kedlaya](https://kskedlaya.org/). 
* Colorado College. Visiting Assistant Professor (2018--2022).
* UC Berkeley. Graduate Student Instructor/Researcher (2011--2018). 
* Université de Strasbourg. Chateaubriand Fellow (2016--2017).
    - Mentor: [Christine Huyghe](https://huyghe.perso.math.cnrs.fr/). 

# Education

* UC Berkeley. PhD in Mathematics (2018).
    - Thesis Advisor: [David Nadler](https://math.berkeley.edu/~nadler/). 
* UC San Diego. BS in Mathematics (2011). 
    - Thesis Advisor: [Dragos Oprea](https://mathweb.ucsd.edu/~doprea/). 
    - Awards: Highest Distinction, Muir Scholar. 
...
{% include_relative other-writing.md %}

# Talks

{% include_relative talk-history.md %}

# Financial Support

* [Zulip](https://zulip.com/) Cloud Standard Sponsorship (2023--). 
* Euclid Fund (Summer 2021). Department of Mathematics and Computer Science, Colorado College. 
* Research and Development Grant (2020). Natural Sciences Division, Colorado College.
* Faculty-Student Collaborative Research Grant (Summer 2019). Colorado College.
* Graduate Student Researcher (Spring 2018). NSF RTG grant DMS-1646385.
* Chateaubriand Fellowship (2016--2017). Embassy of France.
...
{% include_relative teaching-history.md increment=1 %}

# Conferences

## In-Person Attendance

* $\mathrm{Spec}(\bar{\mathbb{Q}})$ (July 2022). Fields Institute, Toronto. Talk: Parametrizing isocrystals. 
...
* D-modules, Geometric Representation Theory, and Arithmetic Applications (December 2017). Oxford University. Poster: Rigid overconvergent isocrystals on $\mathbb{P}^1$.
...
* 2021 Fields Medal Symposium: Peter Scholze (October 2021). Fields Institute, Toronto. 
...
* Developer of open source [TallyBot](https://github.com/sagrawalx/tallybot) for Zulip. 
* Reviewer for [zbMATH Open](https://zbmath.org/).
* Referee for Journal of Algebra and College Mathematics Journal.
<!-- Stacks Project, algstat, SageMath -->

## Departmental

* AWM Mentor (2022--2023). 
* Assessment Committee (2021--2022). 
* Summer Research Survey (2019--2022). 
* Website Committee (2021--2022).
* Inclusive Spaces Committee (2019--2021).
* MAA Liaison (2018--2019).

## Other

* Organizer of [CC's Hindi-Urdu Mehfil](/assets/mehfil) (2020--2022).
* Translator for Mutual Aid NYC (2020).
