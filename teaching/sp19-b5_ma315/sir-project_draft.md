...
Parts 1 and 2 will ask you to do some numerical calculations using a computer. If you are already comfortable using some mathematical computing software that can do calculations with systems of ODEs, I encourage you to use it. If you don't have one you're comfortable with yet, I suggest you use the open source software [Sage](https://www.sagemath.org/).

Here is some code that will generate plots of $S, I$ and $R$ for $t = 0$ through $t = 30$ using the parameters $b = 0.01, k = 0.1$, and $N = 100$, and the initial conditions $I(0) = 1, R(0) = 0$, and $$S(0) = N - (I(0) + R(0)) = 99.$$
